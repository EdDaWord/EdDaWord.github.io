...
export var getBabelPlugins = function getBabelPlugins(options) {
...
var webpackFinal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(config, options) {
    var _options$projectRoot, _options$modulesToTra, _options$modulesToTra2;

    var babelPlugins, root, userModules, modules;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            modules = [].concat(DEFAULT_INCLUDES, _toConsumableArray(userModules)); // fix for uncompiled react-native dependencies
            ...
            config.resolve.extensions = ['.web.js'].concat(_toConsumableArray(config.resolve.extensions));
